...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_todolist_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./shared/todolist.service */
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(todolistService, dialog) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.todolistService.getToDoLists().subscribe(function (success) {
            var list = [];
            list.push(success);
            _this.finaltoDoLists = list[0].filter(function (task) {
              return task.title !== "";
            });
          }, function (error) {});
        }
        ...
        key: "onGetTasks",
        value: function onGetTasks(data) {
          var _this2 = this;

          this.toDoLists = [];
          this.todolistService.getToDoLists().subscribe(function (success) {
            _this2.toDoLists.push(success);

            var duplicate = _this2.toDoLists[0].find(function (list) {
              return list.title == data;
            });

            if (duplicate) {
              _this2._isDuplicate = true;
            } else {
              _this2.submit();
            }
          });
        ...
        value: function submit() {
          ...
          this.todolistService.addToDoLists(task).subscribe(function (success) {
            _this3.todolistService.getToDoLists().subscribe(function (success) {
              var list = [];
              list.push(success);
              _this3.finaltoDoLists = list[0].filter(function (task) {
                return task.title !== "";
              });
            }, function (error) {});
          }, function (error) {
        ...
        value: function _delete(list) {
          ...
          this.todolistService.deleteToDoList(list).subscribe(function (success) {
            _this4.todolistService.getToDoLists().subscribe(function (success) {
              var list = [];
              list.push(success);
              _this4.finaltoDoLists = list[0].filter(function (task) {
                return task.title !== "";
              });
            }, function (error) {});
          }, function (error) {});
        ...
        value: function edit(task) {
          ...
          }).afterClosed().subscribe(function (editedLists) {
            _this5.getToDoListFromServer();
          });
        }
      }, {
        key: "getToDoListFromServer",
        value: function getToDoListFromServer() {
          var _this6 = this;

          this.todolistService.getToDoLists().subscribe(function (success) {
            var list = [];
            list.push(success);
            _this6.finaltoDoLists = list[0].filter(function (task) {
              return task.title !== "";
            });
          }, function (error) {});
        }
        ...
        key: "onTaskStatusUpdate",
        value: function onTaskStatusUpdate(task, status) {
          var _this7 = this;

          var statusEdit = JSON.parse(JSON.stringify(task));
          statusEdit.complete = status === 'Done' ? true : false;
          this.todolistService.editToDoList(task.id, statusEdit).subscribe(function (success) {
            _this7.getToDoListFromServer();
          }, function (error) {});
        }
      }, {
        key: "isDuplicate",
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('alertBox', {
      "static": false
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _edit_task_edit_task_component__WEBPACK_IMPORTED_MODULE_7__["EditTaskComponent"]],
  ...
  function srcAppEditTaskEditTaskComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_todolist_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/todolist.service */
    "./src/app/shared/todolist.service.ts");

    var EditTaskComponent = /*#__PURE__*/function () {
      function EditTaskComponent(dialogRef, data, todolistService) {
      ...
      _createClass(EditTaskComponent, [{
        ...
        key: "onEditTask",
        value: function onEditTask(editedTask) {
          var _this8 = this;

          var editedtask = this.taskToEdit;
          this.todolistService.editToDoList(this.editedTaskId, editedtask).subscribe(function (success) {
            _this8.close();
          }, function (error) {});
        }
      }, {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], EditTaskComponent);
    /***/
  },
  ...
  /***/
  function srcAppSharedTodolistServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TodolistService = /*#__PURE__*/function () {
      ...
      _createClass(TodolistService, [{
        key: "addToDoLists",
        value: function addToDoLists(task) {
        ...
        key: "deleteToDoList",
        value: function deleteToDoList(task) {
          var id = task.id;
        ...
        key: "editToDoList",
        value: function editToDoList(id, task) {
          var url = "http://localhost:3000/posts/" + id;
    ...
    TodolistService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    TodolistService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], TodolistService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! f:\2020\github deployment tes\TODOLIST\todolist\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
